...
const ProjectForm = (props) => {
  ...
  return (
    ...
    >
      {(props) => {
        formikSetter = props.setFieldValue;
        return (
          <div className="project-form">
                        ...
                        <div className="col">
                          <div className="form-group">
                            ...
                            <Select
                              name="serviceType"
                              onFocus={() =>
                                props.setFieldTouched("serviceType")
                              }
                        ...
                        <div className="col-6">
                          <div className="form-group">
                            ...
                            <Select
                              ...
                              onFocus={() =>
                                props.setFieldTouched("clientName")
                              }
                          ...
                          <div className="form-group">
                            ...
                            <div>
                              <DatePicker
                                name="cEndDate"
                                onFocus={() =>
                                  props.setFieldTouched("cEndDate")
                                }
                                className={`form-control ${
                                  props.touched.cEndDate &&
                                  props.errors.cEndDate
                                    ? "is-invalid"
                        ...
                        <div className="col">
                          <div className="form-group">
                            ...
                            <Select
                              name="projectType"
                              onFocus={() =>
                                props.setFieldTouched("projectType")
                              }
                              className={`my-select ${
                        ...
                        <div className="col-6">
                          <div className="form-group">
                            ...
                            <input
                              ...
                              type="text"
                              className={`form-control ${
                                props.touched.empEstHrs &&
                                props.errors.empEstHrs
                                  ? "is-invalid"
                        ...
                        <div className="col-6">
                          <div className="form-group">
                            ...
                            <input
                              ...
                              type="text"
                              className={`form-control ${
                                props.touched.empEstCst &&
                                props.errors.empEstCst
                                  ? "is-invalid"
            ...
            >
              <ModalHeader toggle={togglePlatformEdit}>
                Add Platform
              </ModalHeader>
              <ModalBody>
