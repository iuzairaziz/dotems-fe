...
const ViewResourceCost = (props) => {
  const [resourceCost, setResourceCost] = useState({ name: "", hours: "" });
  ...
  const getData = () => {
    ResourceCostService.getResourceCost()
      .then((res) => {
        console.log(res);
              ...
              <div class="dropdown">
                ...
                <div class="dropdown-menu">
                  <a
                    ...
                    onClick={() => {
                      props.history.push({
                        pathname: `/resource-cost-add/${item._id}`,
                      });
                    }}
                  >
                    View
        ...
        console.log("resurce cst", updatedData);
  ...
  const handleDelete = (id) => {
    ResourceCostService.deleteResourceCost(id)
      .then((res) => {
        ResourceCostService.handleMessage("delete");
        toggleDelete();
      })
      .catch((err) => {
        ResourceCostService.handleError();
        toggleDelete();
      });
  };
...
export default ViewResourceCost;
