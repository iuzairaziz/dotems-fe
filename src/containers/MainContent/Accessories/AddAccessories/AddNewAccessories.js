...
import CountryList from "../AccessoryList/AccessoryList";
import AddCountry from "./AddAccessories";

class AddNewAccessories extends Component {
  constructor() {
    super();
    this.state = {};
  }
                ...
                <ul className="nav nav-tabs nav-tabs-custom" role="tablist">
                  ...
                  <li className="nav-item">
                    <a
                      ...
                      role="tab"
                    >
                      <span className="d-none d-md-block">+ Add Accessory</span>
                      <span className="d-block d-md-none">
