                      ...
                      <div className="form-group m-b-0">
                        ...
                        <div className="colorpicker-default input-group">
                          <input
                            type="text"
                            readonly="readonly"
                            value={this.state.cmp_bkg}
                            className="form-control"
                          />
                          <span className="input-group-append add-on">
                            <button
                              className="btn btn-light picker"
                              type="button"
                              onClick={() =>
                                this.setState({
                                  btn: !this.state.btn,
                            ...
                            >
                              <i
                                style={{
                                  backgroundColor: this.state.cmp_bkg,
                                  marginTop: "2px",
                                }}
                              >
                                &nbsp;&nbsp;&nbsp;&nbsp;
                  ...
                  <div className="card-body">
                    ...
                    <div className="m-t-20">
                      ...
                      {this.state.placementbadge ? (
                        <span className="badgecountright">
                  ...
                  <div className="card-body">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        id="switch2"
                        switch="default"
                        checked={this.state.switch2 ? "checked" : ""}
                        onChange={() =>
                          this.setState({ switch2: !this.state.switch2 })
                        }
                      />
                      <label for="switch2" data-on-label="" data-off-label="" />

                      <input
                        type="checkbox"
                        id="switch3"
                        switch="bool"
                        checked={this.state.switch3 ? "checked" : ""}
                        onChange={() =>
                      ...
                      <input
                        ...
                        id="switch6"
                        switch="primary"
                        checked={this.state.switch4 ? "checked" : ""}
                        onChange={() =>
                      ...
                      <input
                        ...
                        id="switch4"
                        switch="success"
                        checked={this.state.switch5 ? "checked" : ""}
                        onChange={() =>
                      ...
                      <input
                        ...
                        id="switch7"
                        switch="info"
                        checked={this.state.switch6 ? "checked" : ""}
                        onChange={() =>
                      ...
                      <input
                        ...
                        id="switch5"
                        switch="warning"
                        checked={this.state.switch7 ? "checked" : ""}
                        onChange={() =>
                      ...
                      <input
                        ...
                        id="switch8"
                        switch="danger"
                        checked={this.state.switch8 ? "checked" : ""}
                        onChange={() =>
                      ...
                      <input
                        ...
                        id="switch9"
                        switch="dark"
                        checked={this.state.switch9 ? "checked" : ""}
                        onChange={() =>
